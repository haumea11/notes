...
* @param selection is a list of the indices of the
* cards to be replaced.
*/
public void replaceSelectedCards(java.util.List<Integer> selection) {
for (Integer k : selection) {
deal(k.intValue());
}
}
...
*/
public java.util.List<Integer> cardIndexes() {
...
// This bit throws an error on my end.  Not sure how it works for you.
